...
<h1>Мастера</h1>
    <div class="list">
        ...
        <!-- <div class="item">
            <div class='photo'>
                <img src="/~s338923/isbd/img/master-demo.jpeg" alt="master_photo" class="avatar">
            </div>
            <div class='info'>
                <p>Иванов Иван</p>
                <p>Рейтинг: 5.0</p>
                <p>Стаж: 2 года</p>
                <p>Расписание: ПН,ВТ,СР</p>
                <a href="/~s338923/isbd/index.php?masterId=1">Создать заказ</a>
            </div>
        </div>
        <div class="item">
            <div class='photo'>
