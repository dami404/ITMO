...
//        Тут возникает окно со входом в гугл, если пытаться кликнуть на него, то оба теста не пройдут
        {Thread.sleep((long) (Math.random() * 10000));}
        ...
        {Thread.sleep((long) (Math.random() * 10000)); }
        driver.findElement(By.xpath("//input[@name=\"password\"]")).sendKeys("123Aa123123");
        {Thread.sleep((long) (Math.random() * 10000)); }
        driver.findElement(By.xpath("//button[@type=\"submit\"]")).click();
        { Thread.sleep((long) (Math.random() * 10000)); }
        {
