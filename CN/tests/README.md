...
(+1) маршрутизатор не принимает и не обрабатывает ICMP-пакеты
(+1) нет связи со следующим маршрутизатором
(+1) в предыдущем маршрутизаторе не указан маршрут к данному узлу
...
(+1) Ускорение маршрутизации
(+1) Возможность указания физического адреса устройства в адресе IPv6
(+1) Не нужно маскирование адресов
(+1) Не нужен протокол ARP

_____
### Какие записи являются корректными глобальными агрегируемыми уникальными адресами IPv6?
(+1) 2001:0067:89ab:cdff:0b05:0009:0000:c054
(+1) 20сс:17:33a:17:b050:9:0:c054
(+1) 3FFF::12:345
(+1) 3d3d:f:44:ff::1

_____
### Какие записи являются корректными глобальными агрегируемыми уникальными адресами IPv6?
(+1) 2345:0001:90ab:c11f:0005:а129:0000:1054
(+1) 29сс:1:3a:7:b50:91:10:04
(+1) 3fff::ff:5
(+1) 3d4с:f1:1244:ff56:1::

_____
### Какие записи не могут быть корректными глобальными агрегируемыми уникальными адресами IPv6?
(+1) 2fас:317:4a25:1с72:b000:a76:230:4560
(+1) 321:7:a5:17:5b00:91c:1010:f410
(+1) 2c12:80:88:17g:a150:19:5001:1
(+1) 1245:a4:53a0:f17f:3f15:1939:120:5001
(+1) 28f5::777:aa111:74c2:ff34

_____
### Какие записи не могут быть корректными глобальными агрегируемыми уникальными адресами IPv6?
(+1) 30с:17:2a5:177:5b0:9310:1010:f401
(+1) 2702:8:88:7n10:d0:9:5:461
(+1) 2001:1a:253:1f7f:6f15:9999:1022
(+1) 21f::457:a123:c74c:fff1
(+1) 23ab:16:7ab1:d1b1::cc30
...
(+1) При статическом мультиплексировании каждой паре взаимодействующих абонентов выделяется фиксированный временн'ой слот.
(+1) При статистическом мультиплексировании каждая пара взаимодействующих абонентов может использовать любой свободный временн'ой слот.
(+1) При асинхронном мультиплексировании для идентификации абонента-получателя необходимо указывать его адрес.
(+1) При синхронном мультиплексировании идентификации абонента-получателя осуществляется по номеру временн'ого слота.
(+1) При статистическом мультиплексировании паре взаимодействующих абонентов может быть выделен любой временн'ой слот.
...
(+1) абсолютная мощность
(+1) относительная мощность
(+1) опорная мощность

_____
### Выберите правильные утверждения.
(+1) опорная мощность измеряется относительно одного милливатта
(+1) относительная мощность измеряется в децибелах
(+1) абсолютная мощность измеряется в ваттах
(+1) единица измерения опорной мощности - дБм

_____
### Выберите правильные утверждения.
(+1) динамический диапазон характеризует отношение пиковой мощности к минимальной
(+1) динамический диапазон характеризует отношение максимальной мощности к минимальной
(+1) пикфактор характеризует отношение пиковой мощности к средней
(+1) динамический диапазон и пикфактор измеряются в децибелах
